    ...
    <div className="flex justify-between items-center w-full py-5">
      ...
      <div className="flex justify-between items-center gap-4 p-2">
        ...
        <div className="flex gap-1">
          ...
          >
            <SelectTrigger className="w-38 rounded-xl border-gray-400">
              <SelectValue>
          ...
          >
            <SelectTrigger className="w-40 rounded-xl border-gray-400">
              <SelectValue>
        ...
        <div className="flex gap-1">
          ...
          >
            <SelectTrigger className="w-30 rounded-xl border-gray-400">
